### Documentation upon doing the task below
- Checked usage of each classes
- Categorized classes and created package/folder per category
- Implemented repository pattern to decouple data from api
- Implemented viewmodel to separate ui logic from business logic
- Created ui data models to remove dependency from api
- Added unit tests that tests major parts of the app
